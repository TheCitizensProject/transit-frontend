...
export default function PageHeader() {
  return (
    <div className="flex items-center justify-between my-4">
      ...
      <IconHeader icon={<MdOutlineDirectionsTransit className="w-8 h-8" />} text="Transit" />
      <IconHeader icon={<MdOutlineFeedback className="w-8 h-8" />} text="Feedback" />
      <IconHeader icon={<MdOutlineEventSeat className="w-8 h-8" />} text="Events" />
    </div>
  );
}
